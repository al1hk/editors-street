...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-center gap-3 sm:gap-4 pointer-events-none opacity-45 scale-105">
        {/* Row 1: Left scrolling */}
        <div className="flex gap-4 w-[200%] animate-marquee overflow-hidden">
          {ROW_1_TILES.map((clip, i) => (
            <div
              key={`r1-${i}`}
              className="relative w-64 sm:w-80 md:w-96 aspect-video rounded-2xl overflow-hidden shrink-0 border border-white/10 shadow-2xl brightness-90 bg-zinc-900"
            >
              <img
                src={clip.img}
                alt={clip.title}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center space-y-7 sm:space-y-9">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-black font-['Space_Grotesk',sans-serif] uppercase tracking-[-0.03em] leading-[1.04]">
          <span
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white font-medium max-w-2xl mx-auto leading-relaxed tracking-wide drop-shadow-md">
        ...
        <div className="pt-2 sm:pt-4">
          <a
            href="#contact"
            className="glitch-btn-master group px-9 sm:px-14 py-4 sm:py-4.5 rounded-full text-xs sm:text-sm font-black tracking-[0.22em] uppercase shadow-[0_0_35px_rgba(204,255,0,0.5)] hover:shadow-[0_0_65px_rgba(204,255,0,0.9)] flex items-center gap-3 transition-all duration-300"
          >
